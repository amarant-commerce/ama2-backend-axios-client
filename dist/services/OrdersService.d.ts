...
export declare class OrdersService {
     ...
     * @throws ApiError
     */
    static getOrderPaymentTransactionCollection(q?: AmarantGetOrderPaymentTransactionCollectionSearchCriteriaFilter, page?: number, itemsPerPage?: number, include?: string, exclude?: string): CancelablePromise<(AmarantApiPaginatedCollectionResponse & {
     ...
     * @throws ApiError
     */
    static getOrderPaymentTransactionCollectionForOrder(id: number, q?: AmarantGetOrderPaymentTransactionCollectionForOrderSearchCriteriaFilter, page?: number, itemsPerPage?: number, include?: string, exclude?: string): CancelablePromise<(AmarantApiPaginatedCollectionResponse & {
        data: Array<AmarantOrderPaymentTransactionModel>;
    })>;
}
