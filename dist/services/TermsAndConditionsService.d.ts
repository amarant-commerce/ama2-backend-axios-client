...
export declare class TermsAndConditionsService {
     ...
     * @throws ApiError
     */
    static getTermsConditionsCollection(q?: AmarantGetTermsConditionsCollectionSearchCriteriaFilter, page?: number, itemsPerPage?: number, include?: string, exclude?: string): CancelablePromise<(AmarantApiPaginatedCollectionResponse & {
